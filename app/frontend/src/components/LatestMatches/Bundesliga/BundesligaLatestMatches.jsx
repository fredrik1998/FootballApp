...
import {
  ...
  StyledTable,
  StyledWrapper,
} from "./BundesligaLatestMatchesElements";
import { useNavigate } from "react-router-dom";

const BundesligaLatestMatches = () => {
  const dispatch = useDispatch();
  const BundesligaLatestMatches = useSelector(
    (state) => state.Bundesliga.latestMatches
  );
  const BundesligaLatestMatchesStatus = useSelector(
    (state) => state.Bundesliga.latestMatchesStatus
  );
