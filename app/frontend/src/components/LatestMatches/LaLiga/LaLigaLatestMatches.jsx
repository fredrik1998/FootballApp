...
import {
  ...
  StyledTable,
  StyledWrapper,
} from "./LaLigaLatestMatchesElements";

const LaLigaLatestMatches = () => {
  const dispatch = useDispatch();
  const LaLiga = useSelector((state) => state.LaLiga.table);
  const LaLigaLatestMatches = useSelector(
    (state) => state.LaLiga.latestMatches
  );
  const LaLigaLatestMatchesStatus = useSelector(
    (state) => state.LaLiga.latestMatchesStatus
  );
