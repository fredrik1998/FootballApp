...
import {
  ...
  StyledWrapper,
  StyledDiv,
} from "./CLLatestMatchesElements";
import { useNavigate } from "react-router-dom";
const CLLatestMatches = () => {
  const dispatch = useDispatch();
  const CLLatestMatches = useSelector(
    (state) => state.championsLeague.latestMatches
  );
  const CLLatestMatchesStatus = useSelector(
    (state) => state.championsLeague.latestMatchesStatus
  );
