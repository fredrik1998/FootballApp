...
import {
  ...
  StyledTable,
  StyledWrapper,
} from "./Ligue1LatestMatchesElements";

const Ligue1LatestMatches = () => {
  const dispatch = useDispatch();
  const Ligue1 = useSelector((state) => state.Ligue1.table);
  const Ligue1LatestMatches = useSelector(
    (state) => state.Ligue1.latestMatches
  );
  const Ligue1LatestMatchesStatus = useSelector(
    (state) => state.Ligue1.latestMatchesStatus
  );
  useEffect(() => {
