...
import {
  ...
  StyledTable,
  StyledWrapper,
} from "./BundesligaTopAssistsElements";

const BundesligaTopAssists = () => {
  const dispatch = useDispatch();
  const BundesligaTopAssists = useSelector(
    (state) => state.Bundesliga.topAssists
  );
  const BundesligaTopAssistsStatus = useSelector(
    (state) => state.Bundesliga.topAssistsStatus
  );
