...
import {
  ...
  StyledTable,
  StyledLink,
} from "./SerieATopAssistsElements";

const SerieATopAssists = () => {
  const dispatch = useDispatch();
  const SerieATopAssists = useSelector((state) => state.SerieA.topAssists);
  const SerieATopAssistsStatus = useSelector(
    (state) => state.SerieA.topAssistsStatus
  );
  const SerieATopAssistsError = useSelector(
    (state) => state.SerieA.topAssistsError
  );
