...
import {
  ...
  StyledTable,
  StyledWrapper,
} from "./BundesligaTopScorerElements";

const BundesligaTopScorer = () => {
  const dispatch = useDispatch();
  const BundesligaTopScorer = useSelector(
    (state) => state.Bundesliga.topScorers
  );
  const BundesligaTopScorerStatus = useSelector(
    (state) => state.Bundesliga.topScorersStatus
  );
