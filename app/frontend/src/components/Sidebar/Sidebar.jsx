...
const Sidebar = ({ toggleSidebar, isOpen, setIsMobile, hamburgerMenuRef }) => {
  ...
  const getChampionsLeagueEmblem = () => {
    const championsLeague = Leagues.find(
      (league) => league.name === "UEFA Champions League"
    );
  ...
  return (
    ...
    >
      ...
      <StyledLink to="/PL">
        <StyledImage src={getPremierLeagueEmblem()}></StyledImage>Premier League
      </StyledLink>
      <StyledLink to="/CL">
        <StyledImage src={getChampionsLeagueEmblem()}></StyledImage>Champions
        League
      </StyledLink>
      <StyledLink to="/SA">
        <StyledImage src={getSerieAEmblem()}></StyledImage>Serie A
      </StyledLink>
      <StyledLink to="/BL1">
        <StyledImage src={getBundesligaEmblem()}></StyledImage>Bundesliga
      </StyledLink>
      <StyledLink to="/FL1">
        <StyledImage src={getLigue1Emblem()}></StyledImage>Ligue 1
      </StyledLink>
      <StyledLink to="/PD">
        <StyledImage src={getLaLigaEmblem()}></StyledImage>La Liga
      </StyledLink>
    </StyledNav>
  );
};
