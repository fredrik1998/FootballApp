...
const Match = () => {
  ...
  useEffect(() => {
    if (
      (MatchStatus === "idle" && Head2HeadStatus === "idle") ||
      match_id !== prevMatchId.current
    ) {
      ...
      {Match && Match.competition && (
        <StyledWrapper>
          <MatchCard>
            <MatchInfo>
              ...
              <StyledH1>
                ...
                {Match.matchday ? <span> Round {Match.matchday}</span> : null}
                <span> {formatMatchStage(Match.stage)}</span>
              </StyledH1>
            </MatchInfo>
            <MatchDetails>
              <TeamLogo src={Match.homeTeam.crest}></TeamLogo>
              <StyledLink to={`/team/${Match.homeTeam.id}`}>
              ...
              <StyledLink to={`/team/${Match.awayTeam.id}`}>
          ...
          <Head2HeadCard>
            ...
            <LossBadge>
              <Head2HeadText>
                {Head2Head.aggregates.homeTeam.losses}
              </Head2HeadText>
              <strong>Wins</strong>
            </LossBadge>
            <TeamLogo src={Match.awayTeam.crest}></TeamLogo>
                  ...
                  {matchesByDate[date].map((match) => (
                    ...
                    >
                      <td>
                        ...
                        <TeamLink to={`/team/${match.homeTeam.id}`}>
                          {match.homeTeam.shortName}
                        </TeamLink>
                      </td>
                      ...
                      <td>
                        ...
                        <TeamLink to={`/team/${match.awayTeam.id}`}>
                          {match.awayTeam.shortName}
                        </TeamLink>
                      </td>
                    </tr>
